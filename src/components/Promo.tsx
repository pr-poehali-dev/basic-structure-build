    ...
    >
      <div className="fixed top-[-10vh] left-0 h-[120vh] w-full">
        <motion.div style={{ y }} className="relative w-full h-full">
          <img
            src="https://cdn.poehali.dev/projects/be5b1463-ca9e-411e-b91d-0b47ba29abe0/files/4f026c36-585f-4c7b-a8e6-499b0ff348bd.jpg"
            alt="Centrifugal compressor turbine"
      ...
      <p className="absolute bottom-12 right-6 text-white text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-3xl z-10 leading-tight">
        Правильный выбор компрессора — это баланс давления, производительности и надёжности.
        Каждый тип решает свою задачу там, где другой уступает.
      </p>
    </div>
  );
}